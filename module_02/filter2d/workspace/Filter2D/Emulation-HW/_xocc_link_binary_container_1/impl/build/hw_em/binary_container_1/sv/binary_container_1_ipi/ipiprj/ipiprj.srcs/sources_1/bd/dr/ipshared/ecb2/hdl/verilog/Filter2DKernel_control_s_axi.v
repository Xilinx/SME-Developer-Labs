...
`timescale 1ns/1ps
module Filter2DKernel_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER           = 7'h08,
    ADDR_ISR           = 7'h0c,
    ADDR_COEFFS_DATA_0 = 7'h10,
    ADDR_COEFFS_DATA_1 = 7'h14,
    ADDR_COEFFS_CTRL   = 7'h18,
    ADDR_SRC_V_DATA_0  = 7'h1c,
    ADDR_SRC_V_DATA_1  = 7'h20,
    ADDR_SRC_V_CTRL    = 7'h24,
    ADDR_WIDTH_DATA_0  = 7'h28,
    ADDR_WIDTH_CTRL    = 7'h2c,
    ADDR_HEIGHT_DATA_0 = 7'h30,
    ADDR_HEIGHT_CTRL   = 7'h34,
    ADDR_STRIDE_DATA_0 = 7'h38,
    ADDR_STRIDE_CTRL   = 7'h3c,
    ADDR_DST_V_DATA_0  = 7'h40,
    ADDR_DST_V_DATA_1  = 7'h44,
    ADDR_DST_V_CTRL    = 7'h48,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_SRC_V_DATA_0: begin
                    rdata <= int_src_V[31:0];
                end
                ADDR_SRC_V_DATA_1: begin
                    rdata <= int_src_V[63:32];
                end
                ...
                ADDR_DST_V_DATA_0: begin
                    rdata <= int_dst_V[31:0];
                end
                ADDR_DST_V_DATA_1: begin
                    rdata <= int_dst_V[63:32];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_SRC_V_DATA_0)
            int_src_V[31:0] <= (WDATA[31:0] & wmask) | (int_src_V[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_SRC_V_DATA_1)
            int_src_V[63:32] <= (WDATA[31:0] & wmask) | (int_src_V[63:32] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_DST_V_DATA_0)
            int_dst_V[31:0] <= (WDATA[31:0] & wmask) | (int_dst_V[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_DST_V_DATA_1)
            int_dst_V[63:32] <= (WDATA[31:0] & wmask) | (int_dst_V[63:32] & ~wmask);
    end
end
