...
entity Filter2DKernel_control_s_axi is
generic (
...
end entity Filter2DKernel_control_s_axi;
...
architecture behave of Filter2DKernel_control_s_axi is
    ...
    constant ADDR_COEFFS_DATA_0 : INTEGER := 16#10#;
    constant ADDR_COEFFS_DATA_1 : INTEGER := 16#14#;
    constant ADDR_COEFFS_CTRL   : INTEGER := 16#18#;
    constant ADDR_SRC_V_DATA_0  : INTEGER := 16#1c#;
    constant ADDR_SRC_V_DATA_1  : INTEGER := 16#20#;
    constant ADDR_SRC_V_CTRL    : INTEGER := 16#24#;
    ...
    constant ADDR_STRIDE_DATA_0 : INTEGER := 16#38#;
    constant ADDR_STRIDE_CTRL   : INTEGER := 16#3c#;
    constant ADDR_DST_V_DATA_0  : INTEGER := 16#40#;
    constant ADDR_DST_V_DATA_1  : INTEGER := 16#44#;
    constant ADDR_DST_V_CTRL    : INTEGER := 16#48#;
    ...
    signal int_src_V           : UNSIGNED(63 downto 0) := (others => '0');
    ...
    signal int_dst_V           : UNSIGNED(63 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_SRC_V_DATA_0 =>
                        rdata_data <= RESIZE(int_src_V(31 downto 0), 32);
                    when ADDR_SRC_V_DATA_1 =>
                        rdata_data <= RESIZE(int_src_V(63 downto 32), 32);
                    ...
                    when ADDR_DST_V_DATA_0 =>
                        rdata_data <= RESIZE(int_dst_V(31 downto 0), 32);
                    when ADDR_DST_V_DATA_1 =>
                        rdata_data <= RESIZE(int_dst_V(63 downto 32), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_SRC_V_DATA_0) then
                    int_src_V(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_src_V(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_SRC_V_DATA_1) then
                    int_src_V(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_src_V(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_DST_V_DATA_0) then
                    int_dst_V(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_dst_V(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_DST_V_DATA_1) then
                    int_dst_V(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_dst_V(63 downto 32));
                end if;
            end if;
        end if;
    end process;
